...
fn root_package_splits_transitive_too() -> Result<()> {
    ...
    source = { editable = "." }
    dependencies = [
        { name = "anyio", version = "4.2.0", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "python_full_version < '3.12'" },
...
fn root_package_splits_other_dependencies_too() -> Result<()> {
    ...
    source = { directory = "b1" }
    dependencies = [
        { name = "iniconfig", version = "1.1.1", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "python_full_version < '3.12'" },
    ]
    ...
    source = { directory = "b2" }
    dependencies = [
        { name = "iniconfig", version = "2.0.0", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "python_full_version >= '3.12'" },
    ]
