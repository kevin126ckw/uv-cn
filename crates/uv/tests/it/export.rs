...
fn requirements_txt_dependency_conflicting_markers() -> Result<()> {
    ...
    insta::with_settings!(
        ...
        },
        {
            ...
            source = { editable = "." }
            dependencies = [
                { name = "trio", version = "0.10.0", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "sys_platform == 'win32'" },
                { name = "trio", version = "0.25.0", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "sys_platform == 'darwin'" },
            ]
...
fn requirements_txt_non_project_fork() -> Result<()> {
    ...
    insta::with_settings!(
        ...
        },
        {
            ...
            dependencies = [
                { name = "anyio", version = "2.0.0", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "sys_platform == 'win32'" },
                { name = "anyio", version = "3.0.0", source = { registry = "https://pypi.tuna.tsinghua.edu.cn/simple" }, marker = "sys_platform == 'linux'" },
            ]
